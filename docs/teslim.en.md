...
<div class="staj-status">
  ...
  <ul class="staj-status__exceptions">
    <li><span class="staj-status__if">If you interned during an academic term (e.g. Erasmus or another exchange)</span> <span class="staj-status__then"><strong>do not use this form</strong> — submit within three weeks of completing the internship, by <a href="../iletisim/">email</a> (<a href="../sss/#uygunluk-zamanlama">FAQ: Eligibility &amp; Timing</a>).</span></li>
    <li><span class="staj-status__if">If the University insured you through the EK-1</span> <span class="staj-status__then">also send the completion document to the <a href="../surec/#sonrasi">Department of Accounting Affairs</a> — <strong>without it, your next internship's insurance cannot be opened.</strong></span></li>
  </ul>
</div>
