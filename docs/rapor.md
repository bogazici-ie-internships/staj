---
description: "Staj raporu nasıl hazırlanır: rapor şablonunun sekiz bölümü ve her bölümde neyin yazılacağı."
hide:
  - navigation
---
# Rapor Hazırlama
...
!!! ozet "Bir Bakışta"
    ...
    - Raporun ana bölümü olan **Internship Activities** bölümünü **EM bakış açısıyla** yazın; [Konu Rehberi](kurallar.md#konu-rehberi)'nden yararlanın.
...
- **Work Accomplished:** O gün yapılan işler; Internship Activities bölümüyle ilişkili olmalıdır
...
- Şirketin tam adı, kısa tarihçesi, adresi, web bağlantıları
- Sahiplik yapısı; başlıca hissedarlar ve payları
- Faaliyet sektörü; üretilen/sunulan ürün ve hizmetler
- Müşteriler: son kullanıcılar, perakendeciler, diğer üreticiler ve çalışanlar
- Organizasyon şeması ve çalışan sayısı
- Kurumdaki endüstri mühendislerinin yürüttüğü fonksiyonlar
</div>

<div class="staj-outline__card" markdown>
### 6. Internship Activities — Main Body
Bu bölüm raporun **ana bölümüdür**. Staj döneminde yaptığınız faaliyetleri **endüstri
...
- Kazandığınız beceri ve nitelikler
- Üstlendiğiniz sorumluluklar
- Stajın gelecekteki kariyer planınıza etkisi
- Staj faaliyetlerinin ders bilgilerinizle ilişkisi
</div>
...
- Stajdan çıkardığınız temel sonuçlar
- Sektöre dair gözlemler
</div>
