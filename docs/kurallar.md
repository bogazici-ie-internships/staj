---
description: "Zorunlu stajın kuralları: 40 iş günü ve 15 gün üretim şartı, staj kuralları, rapor ve teslim kuralları ile rapor konu rehberi."
hide:
  - navigation
---
# Kurallar
...
- **Sigorta:** kanun gereği tüm stajyerler staj süresince iş kazası ve meslek
  ...
  adımlar [Stajdan Önce](surec/index.md#oncesi) bölümünde açıklanmıştır.
...
- Raporla birlikte **Staj Sicil Formu** ve **Öğrenci Staj Anketi** teslim edilir.
  Ayrıntılar [Stajdan Sonra](surec/index.md#sonrasi) bölümünde yer alır.
...
## Konu Rehberi {: #konu-rehberi }

Staj türünüze göre raporun ana gövdesinde işlemeniz beklenen konular. **Listedeki
tüm soruları yanıtlamak zorunda değilsiniz**; staj türünüze uygun olanlardan
birkaçını derinlemesine işlemeniz yeterlidir.

=== "Üretim Stajı"

    Üretim stajı **üretim/imalat bağlamında** yapılır; **üretimle ilgili ofis
    rolleri de üretim sayılır.** Doğrudan imalatta yer almasanız bile EM
    derslerinin içeriğini uygulamanız beklenir. Amirinizin endüstri mühendisi
    olması **tercih edilir, zorunlu değildir.**
    Aşağıdaki alanlardan **en az 2–3'ünü** uygulamış olmanız beklenir:

    - Süreç analizi
    - Üretim planlama ve çizelgeleme
    - Üretim / proje yönetimi
    - Kapasite ölçümü ve verimlilik analizi
    - Tesis yerleşimi, malzeme taşıma ve depolama
    - Talep tahmini
    - Envanter yönetimi
    - Kaynak tahsisi ve detaylı çizelgeleme
    - İç/dış lojistik planlaması
    - Üretim teknolojileri: JIT, CIM, FMS, GT ve CAD/CAM
    - Ergonomi ve insan faktörleri
    - İş etüdü, yöntem etüdü ve zaman etüdü
    - Yalın üretim ve Altı Sigma
    - İstatistiksel kalite kontrol dâhil kalite planlama ve kontrol
    - Üretime yönelik ERP modülleri; yalnızca **veri girişi** kabul edilmez

=== "Serbest/Genel Staj"

    Serbest/genel staj, üretim dışı ve **EM ile ilgili** herhangi bir rolde
    yapılabilir. Sık görülen alanlar: bilişim, sağlık, finans, ulaştırma,
    iletişim, danışmanlık, turizm yönetimi, pazarlama, yatırım planlaması,
    operasyon planlama, proje yönetimi, insan kaynakları, insan faktörleri,
    iş sağlığı ve güvenliği.

    - Yukarıdaki EM araç ve teknikleri hizmet/yönetim bağlamında uygulanır.
    - Bir **kamu kurumunda veya STK'da** da serbest/genel staj yapılabilir.
      Kızılay, KALDER ve Türkiye Eğitim Gönüllüleri Vakfı bu kurumlara örnektir. STK'da staj
      yapmak isteyenlerin staj danışmanından **sözlü izin** alması gerekir.
    - Fazladan "Üretim" stajı süresi de serbest/genel staja sayılabilir.
