---
description: "Zorunlu staj formları ve belgeleri: Staj Zorunluluk Belgesi, EK-1, Staj Sicil Formu, Öğrenci Staj Anketi ve çizelge şablonu."
hide:
  - navigation
---
# Formlar & Belgeler
...
!!! note "Cumartesi Yazısı ve Ödeme Dekontu / Bordro"
    Bunların hazır bir şablonu yoktur; **şirketten** alınır (hafta sonu çalışıldıysa
    imzalı/kaşeli yazı; şirket devlet katkısı talep ediyorsa ödeme dekontu veya bordro ile
    staj başındaki aynı EK-1). Ayrıntı:
...
!!! info "Bu belgeler dışında belge verilmez"
    ...
    dekontu veya bordro, EK-1 kopyası) **şirketinizden** veya kendi kayıtlarınızdan
    temin edilir.
