...
<div class="staj-status">
  ...
  <ul class="staj-status__exceptions">
    <li><span class="staj-status__if">Ders dönemi içinde staj yaptıysanız (ör. Erasmus/değişim)</span> <span class="staj-status__then"><strong>bu formu kullanmayın</strong> — staj bitiminden en geç 3 hafta içinde <a href="../iletisim/">e-posta ile</a> gönderin (<a href="../sss/#uygunluk-zamanlama">ayrıntı</a>).</span></li>
    <li><span class="staj-status__if">Sigortanız EK-1 ile yapıldıysa</span> <span class="staj-status__then">bu forma ek olarak tamamlama belgesini <a href="../surec/#sonrasi">Hesap İşleri'ne</a> iletin.</span></li>
  </ul>
</div>
