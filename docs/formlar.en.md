...
!!! note "Saturday Work Letter and payment receipt / payslip"
    There is no standard template for these documents. Obtain them from the
    **company**: a signed or stamped letter if you worked on a Saturday; if the
    company is applying for reimbursement, a payment receipt or payslip plus the
    same EK-1 from the start of the internship. See
    [After the Internship](surec/index.md#sonrasi) for details.
...
!!! info "No other documents are issued"
    ...
    or a payment receipt / payslip (and your EK-1 copy), from **your company**
    or your own records.
